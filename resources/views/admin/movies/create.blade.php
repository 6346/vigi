    ...
    <form action="{{ route('admin.Motorcycles.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" max="1000" name="runtime" id="runtime" placeholder="Greitis">
            </div>
            ...
            <x-forms.multi-relation-select :tagName="'model'" :relationItems="$model" :optionDisplay="'fullName'" />
